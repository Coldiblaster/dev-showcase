...
PÁGINAS — Novidades:
- ${PERSONAL.siteUrl}/novidades — Changelog visual com timeline animada de todas as versões. Badges por tipo (feature, fix, refactor, improvement), links diretos para cada conteúdo novo. Versão atual: 0.12.0.
...
NÚMEROS: 6 implementações + 3 ferramentas + 13 guias + 7 páginas de documentação/contribuição = 29 conteúdos técnicos, 4 idiomas, versão 0.12.0.
